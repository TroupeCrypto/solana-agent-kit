# Contributing to Troupe CryptoSpace Solana Agent Kit

First off, thank you for considering contributing to Troupe CryptoSpace's Solana Agent Kit! 🎉 Your contributions are **greatly appreciated**.

## Table of Contents

- [Contributing to Troupe CryptoSpace Solana Agent Kit](#contributing-to-troupe-cryptospace-solana-agent-kit)
...
1. **Search** the [existing issues](https://github.com/TroupeCrypto/solana-agent-kit/issues) to make sure it hasn't been reported.
...
We welcome your ideas for improving the toolkit! To suggest an enhancement:

1. **Search** the [existing issues](https://github.com/TroupeCrypto/solana-agent-kit/issues) to see if it's already been suggested.
...
Check the [Good First Issues](https://github.com/TroupeCrypto/solana-agent-kit/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) to get started!
...
For security vulnerabilities, please follow the [responsible disclosure](SECURITY.md) process.
